...
#  estimated_value_of_home            :string(255)
#  annual_property_tax_amount         :string(255)
#  annual_homeowners_insurance        :string(255)
...
class Secmorapp < ActiveRecord::Base
	#checking for required fields
	validates_presence_of :loan_type, :amount_requested, :applicant_name, :applicant_account_number, :applicant_address, :applicant_city, :applicant_state, :applicant_zip, :applicant_time_at_residence, :applicant_monthly_payment, :applicant_home_phone, :email_address, :applicant_ssn, :applicant_date_of_birth, :applicant_employer, :applicant_position, :mortgage_type, :estimated_value_of_home, :annual_property_tax_amount, :annual_homeowners_insurance
