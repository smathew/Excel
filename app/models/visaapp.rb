# == Schema Information
# Schema version: 20101014130834
#
# Table name: visaapps
#
#  id                                 :integer         not null, primary key
#  visa_type                          :string(255)
